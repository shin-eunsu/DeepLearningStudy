...
class_name_list = ('sun', 'honey_butter_chip', 'pocachip', 'doritos', 'sinjjang', 'ggobukchip')


def get_train_txt():
    list_ = os.listdir('/home/cu/alexeyAB/darknet/test_img')
    dstpath = '/home/cu/alexeyAB/darknet/data/test.txt'
